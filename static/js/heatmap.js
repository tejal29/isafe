$( document ).ready(function(){
    ...
    points  = map.featureLayer.getGeoJSON();

    var feature_layer = L.mapbox.featureLayer();    //define feature layer

        // Add each marker point to the heatmap.
    feature_layer = L.mapbox.featureLayer(points);    //add features to the feature_layer
    ...
    //         addHeat(data, function(){                  //call the heat function
