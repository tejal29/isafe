$( document ).ready(function(){
  ...
  //     $.getJSON('/get_partners', { start_date: start_date, end_date: end_date } ).done(function(data){ //pass in the entered start and end dates and get the GeoJSON objects to be added to the map
  ...
  //   $.getJSON('/get_partners', { start_date: [], end_date: [] } ).done(function(data){ //this will load when the user goes to the points of interest page, it will show crimes in the default date range period
  //       addMarkerLayer(data, function(){
  //         addFilters();
  ...
  $('#partners_route').removeClass('active');
  $('#find_partners_route').addClass('active');
